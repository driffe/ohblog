    ...
    roles: [
      {
        ...
        responsibilities: [
          ...
          "Built end-to-end pagination for 9,800+ tag-archive pages on KQED.org: CSR/SSR canonical redirects, dynamic SEO tags driven from Redux state, VoiceOver accessibility, and 404 handling for invalid page requests.",
